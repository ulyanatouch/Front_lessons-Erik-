...
// console.log(numbers[i] numbers_squared);
// }
...
// const numbers_squared = [1, 4, 9, 16, 25];
// const last_elem = numbers_squared[numbers_squared.length - 1];
// console.log(last_elem); // 25
...
const formattedString = "User's name is <FIRST_NAME> <LAST_NAME>. He is <AGE> years old."; 
console.log(formattedString); // User's name is Ivan Ivanov. He is 20 years old.
